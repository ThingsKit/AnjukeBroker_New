...
@property (nonatomic, strong) void (^finishSendMessageBlock)(NSArray *message,AXMessageCenterSendMessageStatus status ,AXMessageCenterSendMessageErrorTypeCode errorType);
