...
@implementation AXELCAssetTablePicker
...
- (void)preparePhotos
{
    @autoreleasepool {
        ...
        [self.assetGroup enumerateAssetsUsingBlock:^(ALAsset *result, NSUInteger index, BOOL *stop) {
            ...
            AXELCAsset *elcAsset = [[AXELCAsset alloc] initWithAsset:result];
            ...
            {
                isAssetFiltered = [self.assetPickerFilterDelegate assetTablePicker:self isAssetFilteredOut:(AXELCAsset*)elcAsset];
            }
...
{	
	...
	for (AXELCAsset *elcAsset in self.elcAssets) {
...
{    
    ...
    AXELCAssetCell *cell = (AXELCAssetCell*)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];

    if (cell == nil) {		        
        cell = [[AXELCAssetCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
    }
...
- (int)totalSelectedAssets
{
    ...
    for (AXELCAsset *asset in self.elcAssets) {
		if (asset.selected) {
            count++;	
		}
	}
