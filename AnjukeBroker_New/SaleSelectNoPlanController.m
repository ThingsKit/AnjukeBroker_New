...
#pragma mark - log
- (void)sendAppearLog {
    [[BrokerLogger sharedInstance] logWithActionCode:ESF_DJ_ADD_LIST_ONVIEW page:ESF_DJ_ADD_LIST_PAGE note:[NSDictionary dictionaryWithObjectsAndKeys:[Util_TEXT logTime], @"ot", nil]];
}
...
-(void)rightButtonAction:(id)sender{
    [[BrokerLogger sharedInstance] logWithActionCode:ESF_DJ_ADD_LIST_CLICK_OK page:ESF_DJ_ADD_LIST_PAGE note:nil];
    if(self.isLoading){
        return ;
    }
    [self doFixed];
...
- (void)doBack:(id)sender{
    [super doBack:self];
    [[BrokerLogger sharedInstance] logWithActionCode:ESF_DJ_ADD_LIST_CLICK_CANCEL page:ESF_DJ_ADD_LIST_PAGE note:nil];
}
@end
