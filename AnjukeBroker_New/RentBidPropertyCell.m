...
-(void)setValueForCellByDataModel:(id) dataModel{
    if([dataModel isKindOfClass:[NSDictionary class]]){
        ...
        self.price.text = [NSString stringWithFormat:@"%@ %@室%@厅%@卫 %@平 %@%@", [propInfo objectForKey:@"commName"], [propInfo objectForKey:@"roomNum"], [propInfo objectForKey:@"hallNum"], [propInfo objectForKey:@"toiletNum"], [propInfo objectForKey:@"area"], [propInfo objectForKey:@"price"], [propInfo objectForKey:@"priceUnit"]];
