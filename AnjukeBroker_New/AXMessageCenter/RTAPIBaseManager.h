...
@property (nonatomic, readonly) RTServiceType serviceType;

/** 是否正在等待api */
@property (nonatomic, readonly) BOOL isLoading;

/*
 这个数据是api返回的json生成的dictionary。
 一般情况下，开发者是不应该直接使用这个变量的，这个变量只是为了给将来的manager进一步扩展预留的。
 如果需要获得这个数据，使用[manager fetchDataWithReformer:nil];来获得。
 */
@property (nonatomic, strong, readonly) NSDictionary *fetchedRawData;
...
@property (nonatomic, readonly) RTAPIManagerRequestType requestType;
